    ...
    <div className="text-white max-w-[1150px] pb-24 px-5">
      ...
      <div className="flex md:flex-row flex-col-reverse items-center justify-between mb-24">
        ...
        <div className="md:w-[50%] flex flex-row gap-5">
          <div className="border-[1px] border-[#FFFFFF30] shadow-lg shadow-[#121E13]/50 bg-[#121E13] flex h-max flex-col rounded-3xl sm:p-5 p-2  gap-1">
            {isOpen && (
              <p className="text-[51px] font-bold text-[#FFFFFF24]">1</p>
            )}
            <h2 className="sm:text-[41px] text-[30px] font-medium text-[#FFFFFFD1]">
          ...
          <div className="border-[1px] border-[#FFFFFF30] shadow-lg shadow-[#241B08AD]/50 bg-[#241B08AD] flex h-max flex-col rounded-3xl sm:p-5 p-2 gap-1 mt-9">
            {isOpen && (
      ...
      <div>
        ...
        <div className="flex flex-row my-3 gap-5">
          ...
          <div className="flex flex-col gap-3 justify-end">
            <h3 className="text-[#FFFFFFB3] w-[60%] sm:text-[40px] text-[30px] font-bold leading-[45px]">
              Your true identity,{" "}
              <span className="bg-gradient-to-r from-[#9cff9f]  via-[#5af84a] to-[#5af84a] inline-block text-transparent bg-clip-text ">
                managed
              </span>{" "}
        ...
        <div className="flex flex-row my-3 gap-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="text-[#797878F5] sm:text-[22px] text-[18px] font-semibold leading-tight">
